...
namespace ProyectoMVC_AlexiaSabate.DAL
{
    public class TipoAnimalDAL
    {
        private string connectionString = "Server=85.208.21.117,54321;Database=AlexiaAnimales;User Id=sa;Password=Sql#123456789;TrustServerCertificate=True;";
